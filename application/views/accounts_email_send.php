                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Type Email</span>
                                 ...
                                 <div class="portlet-body">
                                    <form role="form" action="<?php echo base_url('table_accounts/send_mail'); ?>" method = "POST">
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Recipients</label>
                                            <!-- <input type="text" placeholder="All Accounts" class="form-control" /> </div> -->
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Sender</label>
                                            <input type="text" name="senderfrom"  class="form-control" required /> 
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group mt-repeater">
                                            <div data-repeater-list="group-b">
                                                ...
                                                <div data-repeater-item class="mt-repeater-item mt-overflow">
                                                    <label class="control-label" style="padding-left: 15px;">Message</label>
                                                    <div class="mt-repeater-cell">
                                                         <textarea class="form-control" rows="8" placeholder="Hello Sir," name="message" required ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
