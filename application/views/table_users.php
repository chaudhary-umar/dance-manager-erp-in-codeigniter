...
<i class="fa fa-file-text-o"></i> CSV </span></a>
                                    ...
                                    <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('add_user'); ?>"><span class="ladda-label">
                                   ...
                                   <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                    ...
                                    if($fetch_data->num_rows() >0)
                                    {
                                        foreach ($fetch_data->result() as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                <td>
                                                    <?php echo anchor("table_accounts/view/{$row->id}", 'View', ['class'=>'fa fa-eye']);?></a>
                                                    <?php echo anchor("table_accounts/update/{$row->id}", 'Update', ['class'=>'fa fa-pencil-square-o']);?></a>
                                                    <?php echo anchor("table_accounts/move/{$row->id}", 'Move', ['class'=>'fa fa-plane']);?></a>
                                                    <?php echo anchor("table_accounts/delete/{$row->id}", 'Delete', ['class'=>'fa fa-trash-o']);?></a>
