                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('table_classes/edit'); ?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="account_no" type="text" class="form-control" value="<?php echo $data->classcode; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="first_name" type="text" class="form-control" value="<?php echo $data->instructor; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3">Current Roll</label>

                                                <div class="col-md-4">

                                                <input name="last_name" type="text" class="form-control" value="<?php echo $data->currentenroll; ?>">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3">Tuition Amount</label>

                                                <div class="col-md-4">

                                                <input name="city" type="text" class="form-control" value="<?php echo $data->tuitionamount; ?>">
                                            ...
                                            <input name="city" type="text" class="form-control" value="<?php echo $data->duration; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo date(" d M, Y", strtotime($data->dateregistered)); ?>">
                                ...
                                <div class="row">
                                                ...
                                                <a href="<?php echo base_url();?>table_classes"> <button class="btn blue">
