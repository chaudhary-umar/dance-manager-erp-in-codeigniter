                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Reports Accounts</span>
...
<a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/reports_account_pdf'); ?>"><span class="ladda-label">
...
<i class="fa fa-file-text-o"></i> CSV </span></a> 
                                    ...
                                    <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('report_accounts/add/'); ?>"><span class="ladda-label">
                                        <i class="glyphicon glyphicon-plus"></i> ADD </span></a> 
                                    </button>                                    <div class="table-toolbar">
