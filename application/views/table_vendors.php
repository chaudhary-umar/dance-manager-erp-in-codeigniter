                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Table Vendors</span>
...
<a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/vendors_pdf'); ?>"><span class="ladda-label">
...
<a style="text-decoration:none;" href="<?php echo site_url('excel_export/action_vendors'); ?>"><span class="ladda-label">
...
<i class="fa fa-file-text-o"></i> CSV </span></a> 
                                    ...
                                    <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('table_vendors/add/'); ?>"><span class="ladda-label">
                                    ...
                                    if($fetch_data->num_rows() >0)
                                    {
                                        foreach ($fetch_data->result() as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                <td>
                                                <!-- <a href="table_vendors/view/<?php echo $row->id; ?>" title="View Details"><i class="fa fa-eye" aria-hidden="true" style="background: #f39c12; color:#fff"></i></a> -->
                                                <a href="table_vendors/update/<?php echo $row->id; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" style="background: #62E04A; color: #fff;"></i></a>
                                                <a href="table_vendors/delete/<?php echo $row->id; ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"style="background: #ff0000; color: #fff;"></i></a>
