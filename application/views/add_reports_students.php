                            ...
                            <div class="portlet light form-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">INSERT Data</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method = "POST" action="<?php echo base_url('report_students/register'); ?>" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="account_no" placeholder="Enter account no!" required> </div>
                                            </div>
