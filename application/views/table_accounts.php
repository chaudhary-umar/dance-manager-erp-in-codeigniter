                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Manage Accounts</span>
...
<a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/account_pdf'); ?>"><span class="ladda-label">
...
<a style="text-decoration:none;" href="<?php echo site_url('excel_export/action'); ?>"><span class="ladda-label">
...
<i class="fa fa-file-text-o"></i> CSV </span></a>
                                    ...
                                    <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('table_accounts/add/'); ?>"><span class="ladda-label">
                                    ...
                                    <button type="button" class="btn black mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('table_accounts/email_view/'); ?>"><span class="ladda-label">
                                        <i class="glyphicon glyphicon-envelope"></i> Send Mail</span></a>
                                    </button>
                                    <button type="button" class="btn black mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('table_accounts/send_sms/'); ?>"><span class="ladda-label">
                                        <i class="glyphicon glyphicon-phone"></i> Send SMS</span></a>
                                    </button>
                                    <button type="button" class="btn black mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                    <a href="<?php echo base_url()?>bulk_invoice/index">
                                        <i class="glyphicon glyphicon-credit-card"></i> Bulk Invoice</span></a>
                                    </button>
                                   ...
                                   <col width="80"> -->
                                        <thead style="color: #26C6DA;">
                                            ...
                                            <tr>
                                                ...
                                                <th width="12%" class="center">  Actions </th>
                                        ...
                                        foreach ($fetch_data->result() as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                               ...
                                               <!-- <a href="table_accounts/view/<?php echo $row->id; ?>" title="View Details"><i class="fa fa-eye" aria-hidden="true" style="background: #f39c12; color:#fff"></i></a>-->
                                                <a href="table_accounts/update/<?php echo $row->id; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" style="background: #62E04A; color: #fff;"></i></a>
