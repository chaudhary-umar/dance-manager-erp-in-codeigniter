                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('table_accounts/edit_data'); ?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-actions text-center">
                                            ...
                                            <input name="postSubmit" type="submit" class="btn btn-primary" value="Move to Prospects"/>
