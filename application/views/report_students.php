...
<a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/reports_students_pdf'); ?>"><span class="ladda-label">
...
<i class="fa fa-file-text-o"></i> CSV </span></a> 
                                    ...
                                    <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('report_students/add/'); ?>"><span class="ladda-label">
