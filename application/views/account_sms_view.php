                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Type SMS</span>
                                 ...
                                 <div class="portlet-body">
                                    <form role="form" action="#" method = "POST">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Number</label>
                                            <input type="phone" name="email"  class="form-control" required /> 
                                        </div>
                                        <div class="form-group mt-repeater">
                                            <div data-repeater-list="group-b">
                                                <div data-repeater-item class="mt-repeater-item mt-overflow">
                                                    <label class="control-label" style="padding-left: 15px;">SMS Message</label>
