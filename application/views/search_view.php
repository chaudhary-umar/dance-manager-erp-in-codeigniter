                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method = "POST" action="<?php echo base_url('table_accounts/search'); ?>" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                        ...
                                        <div class="col-md-offset-5 col-md-9">
                                            <button type="submit" name="postSubmit" class="btn blue">Submit</button>
                                        </div>
                                        </div>
