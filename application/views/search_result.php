                ...
                <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <a href="<?php echo site_url('table_accounts/logout/'); ?>" class="nav-link nav-toggle">
                                ...
                                <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="help-block"><?php echo date(" d M, Y", strtotime($data->date_registered)); ?>  </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                   <a href="<?php echo base_url();?>table_accounts/search_view"> <button class="btn blue">
