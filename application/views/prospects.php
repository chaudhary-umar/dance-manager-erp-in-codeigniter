                                   ...
                                   <col width="80">
                                    ...
                                    if($fetch_data->num_rows() >0)
                                    {
                                        foreach ($fetch_data->result() as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                <td>
                                                <!-- <a href="prospects/view/<?php echo $row->id; ?>" title="View Details"><i class="fa fa-eye" aria-hidden="true" style="background: #f39c12; color:#fff"></i></a> -->
                                                <a href="prospects/update/<?php echo $row->id; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" style="background: #62E04A; color: #fff;"></i></a>
                                                <a href="prospects/delete/<?php echo $row->id; ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"style="background: #ff0000; color: #fff;"></i></a>
