                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Update Data</span>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('table_users/edit'); ?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="email-oo" type="text" class="form-control" value="<?php echo $data->email; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password--oo" type="password" class="form-control" value="<?php echo $data->password; ?>">
                                ...
                                <div class="row">
                                                ...
                                                <a href="<?php echo base_url();?>table_users"> <button class="btn blue">
