                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Bulk Invoice</span>
                                 ...
                                 <div class="portlet-body">
                                    <form role="form" action="<?php echo base_url('bulk_invoice/send_invoice'); ?>" method = "POST">
                                        <div class="form-group">
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Account Name</label>
                                            <input type="text" name="accountname"  class="form-control" required /> 
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Address</label>
                                            <input type="text" name="address"  class="form-control" required /> 
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Email</label>
                                            <input type="email" name="email"  class="form-control" placeholder="Clients Email you want to send email" required /> 
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Class Attended</label>
                                            <input type="text" name="attended"  class="form-control" placeholder="Classes the students attend" required /> 
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" style="padding-left: 15px;">Charges Due</label>
                                            <input type="text" name="charges"  class="form-control" required />
                                        </div>
                                        <div class="form-group mt-repeater">
                                            <div data-repeater-list="group-b">
                                                <div data-repeater-item class="mt-repeater-item mt-overflow">
                                                    <label class="control-label" style="padding-left: 15px;">Class Description</label>
                                                    <div class="mt-repeater-cell">
                                                         <textarea class="form-control" rows="4" placeholder="Type Here" name="description" required ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-5 col-md-7">
                                                    <button type="submit" class="btn btn-circle green">Send Invoice</button>
