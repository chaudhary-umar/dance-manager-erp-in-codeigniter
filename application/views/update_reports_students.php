                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('report_students/edit'); ?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="first_name" type="text" class="form-control" value="<?php echo $data->firstname; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="last_name" type="text" class="form-control" value="<?php echo $data->lastname; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo date(" d M, Y", strtotime($data->date_registered)); ?>">
                                ...
                                <div class="row">
                                                ...
                                                <div class="text-center">
                                                   ...
                                                   <a href="<?php echo base_url();?>report_students"> <button class="btn blue">
