                ...
                <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item ">
                        ...
                        <li class="nav-item  ">
                            ...
                            <a href="attendance.html" class="nav-link nav-toggle">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('accounts_charges/edit'); ?>" class="form-horizontal form-bordered">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="account_no" type="text" class="form-control" value="<?php echo $data->accountno; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3">Reg Fee</label>

                                                <div class="col-md-4">

                                                <input name="reg_fee" type="text" class="form-control" value="<?php echo $data->registration_fee; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3">Recital Fee</label>

                                                <div class="col-md-4">

                                                <input name="recital_fee" type="text" class="form-control" value="<?php echo $data->recital_fee; ?>">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <label class="control-label col-md-3">Dance Shoes</label>

                                                <div class="col-md-4">

                                                <input name="dance_shoes" type="text" class="form-control" value="<?php echo $data->dance_shoes; ?>">
                                            ...
                                            <label class="control-label col-md-3">Tuitions</label>

                                            <div class="col-md-4">

                                            <input name="tuitions" type="text" class="form-control" value="<?php echo $data->monthly_tuitions; ?>">
                                            ...
                                            <label class="control-label col-md-3">Costume</label>

                                            <div class="col-md-4">

                                            <input name="costume" type="text" class="form-control" value="<?php echo $data->costume; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="date" type="text" class="form-control" value="<?php echo date(" d M, Y", strtotime($data->payment_date)); ?>">
                                        ...
                                        <div class="form-actions text-center">
                                            ...
                                            <input name="postSubmit" type="submit" class="btn btn-primary" value="Update"/>
                                ...
                                <div class="row">
                                                ...
                                                <a href="<?php echo base_url();?>table_accounts"> <button class="btn blue">
