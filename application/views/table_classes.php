                ...
                <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li class="nav-item start active open">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item  ">
                                <a href="prospects" class="nav-link ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Table Classes</span>
                                ...
                                <a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/classes_pdf'); ?>"><span class="ladda-label">
                                ...
                                <a style="text-decoration:none;" href="<?php echo site_url('excel_export/action_classes'); ?>"><span class="ladda-label">
                                ...
                                <a style="text-decoration:none;" href="<?php echo site_url('users/students_CSV'); ?>"><span class="ladda-label">
                                <i class="fa fa-file-text-o"></i> CSV </span></a> 
                                </button>
                                <button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                <a style="text-decoration:none;" href="<?php echo site_url('table_classes/add/'); ?>"><span class="ladda-label">
                                <i class="glyphicon glyphicon-plus"></i> ADD </span></a> 
                                </button>
                                <button type="button" class="btn black mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
                                        <a style="text-decoration:none;" href="<?php echo site_url('table_classes/email_view/'); ?>"><span class="ladda-label">
                                        <i class="glyphicon glyphicon-envelope"></i> Send Mail</span></a>
                                </button>
                                    ...
                                    <label style="margin-bottom: 20px !important;"><strong style="padding-left: 26px;">Selection</strong><select name="sample_1_length" aria-controls="sample_1" class="form-control input-sm input-xsmall" style="width: 128px!important;"><option value="5">All Classes</option><option value="15">All Classes</option><option value="20">Option 1</option><option value="-1">All</option></select></label>
                                     ...
                                     <col width="80">
                                        <thead style="color: #26C6DA;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="center"> Current Roll </th>
                                                <th class="center"> Tuition Amount </th>
                                    ...
                                    if($fetch_data->num_rows() >0)
                                    {
                                        foreach ($fetch_data->result() as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                <!-- <a href="table_classes/view/<?php echo $row->id; ?>" title="View Details"><i class="fa fa-eye" aria-hidden="true" style="background: #f39c12; color:#fff"></i></a> -->
                                                <a href="table_classes/update/<?php echo $row->id; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" style="background: #62E04A; color: #fff;"></i></a>
                                                <a href="table_classes/delete/<?php echo $row->id; ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"style="background: #ff0000; color: #fff;"></i></a>
                                                ...
                                                <td>
                                                    <?php echo $row->currentenroll; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row->tuitionamount; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row->duration; ?>
                                                </td>
                                                <td>
                                                    <?php echo date(" d M, Y", strtotime($row->dateregistered)); ?> 
                                                </td>
