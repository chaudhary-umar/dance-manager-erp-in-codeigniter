...
<a style="text-decoration:none;" href="<?php echo site_url('htmltopdf/reports_classes_pdf'); ?>"><span class="ladda-label">
...
<button type="button" class="btn purple mt-ladda-btn ladda-button btn-outline" data-style="slide-right" data-spinner-color="#333">
<a style="text-decoration:none;" href="<?php echo site_url('report_classes/add/'); ?>"><span class="ladda-label">
