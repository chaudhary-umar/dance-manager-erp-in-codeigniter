                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" action="<?php echo base_url('table_vendors/edit'); ?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="account_no" type="text" class="form-control" value="<?php echo $data->vendorcode; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="first_name" type="text" class="form-control" value="<?php echo $data->vendor; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="last_name" type="text" class="form-control" value="<?php echo $data->address; ?>">
                                            ...
                                            <input name="city" type="text" class="form-control" value="<?php echo $data->state; ?>">
                                            ...
                                            <input name="city" type="text" class="form-control" value="<?php echo $data->contact_no; ?>">
                                            ...
                                            <input name="city" type="text" class="form-control" value="<?php echo $data->website; ?>">
                                ...
                                <div class="row">
                                                ...
                                                <a href="<?php echo base_url();?>table_vendors"> <button class="btn blue">
