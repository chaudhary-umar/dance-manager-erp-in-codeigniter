                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Add Charges</span>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method = "POST" action="<?php echo base_url('accounts_charges/register'); ?>" class="form-horizontal form-bordered">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="account_no" placeholder="Enter account no!" > </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="exampleInputPassword1">Registration Fee</label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="reg_fee" placeholder="Registration Fee" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="exampleInputPassword1">Recital Fee</label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rectical_fee" placeholder="Recital Fee" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="exampleInputPassword1">Dance shoes</label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="dance_shoes" placeholder="Dance shoes" >
                                            ...
                                            <label for="exampleInputPassword1">Tuitions</label>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="tuitions" placeholder="Tuitions" >
                                            ...
                                            <label for="exampleInputPassword1">Costume</label>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="costume" placeholder="Costume" >
                                ...
                                <div class="row">
                                                ...
                                                <a href="<?php echo base_url();?>accounts_charges"> <button class="btn blue">
