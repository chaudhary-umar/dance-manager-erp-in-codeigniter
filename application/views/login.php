...
<head>
    ...
    <meta content="Dance Manager Online" name="description" />
    ...
    <link rel="shortcut icon" href="assets/logodance.png" /> </head>
    ...
    <div class="content">
        ...
        <div class="logo">
            ...
            <a href="index.html">
                ...
                <img src="assets/logodance.png" alt="" /> </a>

        </div>

        <!-- BEGIN LOGIN FORM -->

        <form class="login-form" action="<?php echo base_url() ?>login/login_validation" method="post">
            ...
            <?php if ($this->session->flashdata('error')){?>
                        ...
                        <div style="color:red;font-weight:bolder; padding-left: 22px; padding-bottom: 10px;"> <?php echo $this->session->flashdata('error'); ?> </div>
        ...
        <div>
            ...
            <p> no worries, click on button below to reset your password. </p>

        </div>

        <div class="form-actions">

            <a href="forgot"><button type="submit" class="btn red btn-block uppercase">Forgot password </button></a>
