...
<body>
  ...
  <tr>
    <td bgcolor="#000000"><table width="100%" border="0" cellspacing="5" cellpadding="0">
      <tr>
        <td align="left" valign="middle" style="background:url(img/done.jpg) left no-repeat; padding-left:20px;" >New User</td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td align="center" valign="top">
        <iframe height="300" width="560" style="width:100%;" src="system-settings-user-new2.php" frameborder="0" scrolling="auto" ></iframe>
    </td>
  </tr>
  <tr>
