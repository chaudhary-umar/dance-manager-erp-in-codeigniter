...
<table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th width="50">#</th>
                                    <th>Column Name <input type="button" name="button2" id="button2" value="Previous" class="form-control"  style="width:100px; float:right;" onClick="window.location='columns.php';"></th>
...
?>                                
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td style="font-size:16px;"><?php echo $row_tablelist['COLUMN_NAME']; ?></td>
                                    <td>
                                    <input name="checkbox<?php echo $i; ?>" type="checkbox" id="checkbox<?php echo $i; ?>" value="<?php echo $row_tablelist['COLUMN_NAME']; ?>" class="form-control" />
                                    </td>
                                </tr>
